...
/**
 * Lazy-loaded SaveAsTemplateDialog
 * Only loaded when user clicks "Save as Template" button
 */
export const LazySaveAsTemplateDialog = dynamic(
    () => import('./SaveAsTemplateDialog').then((mod) => mod.SaveAsTemplateDialog),
    {
        loading: DialogLoading,
        ssr: false,
    }
