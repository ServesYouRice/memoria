    ...
    items: [
      {
        ...
        content: {
          ...
          text: "Enter your research topic here",
        },
      },
      {
        type: "NOTE",
        ...
        width: 200,
        height: 200,
        content: { title: "Key Findings", text: "" },
      },
      {
        type: "NOTE",
        x: 220,
