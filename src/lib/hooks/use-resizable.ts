...
export interface ResizeHandlers {
    ...
    startResize: (corner: ResizeCorner, e: React.MouseEvent | React.TouchEvent) => void;
...
export function useResizable(options: ResizeOptions): [ResizeState, ResizeHandlers] {
    const {
        initialWidth,
        initialHeight,
        minWidth = 50,
    ...
    const handleResize = useCallback(
        ...
        [aspectRatio, minWidth, minHeight, maxWidth, maxHeight, clamp, onResize, getEventCoords]
    );
