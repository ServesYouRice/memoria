    ...
    <Box sx={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', bgcolor: 'background.default' }}>
        ...
        <Toolbar sx={{ gap: 1 }}>
            ...
            {NAV_ITEMS.map((item) => (
              <Button
                ...
                sx={{
                  ...
                  bgcolor: (theme) =>
                    isActive(item.href) ? alpha(theme.palette.primary.main, 0.08) : 'transparent',
                  '&:hover': {
          ...
          <Tooltip title="Notifications">
            <IconButton
              ...
              component={Link}
              href="/notifications"
              sx={{ color: isActive('/notifications') ? 'primary.main' : undefined }}
            >
              <NotificationsIcon />
            </IconButton>
          </Tooltip>
          ...
          >
            ...
            <Divider sx={{ mb: 0.5 }} />
            <MenuItem component={Link} href="/settings" onClick={closeAccountMenu}>
              <ListItemIcon>
                <SettingsIcon fontSize="small" />
              </ListItemIcon>
              Settings
            </MenuItem>
            <MenuItem component={Link} href="/api-keys" onClick={closeAccountMenu}>
              <ListItemIcon>
      ...
      <Drawer open={drawerOpen} onClose={() => setDrawerOpen(false)}>
        <Box sx={{ width: 264 }} role="navigation" aria-label="Main navigation">
          ...
          <Divider />
          <List>
            {[...NAV_ITEMS, { label: 'Notifications', href: '/notifications', icon: NotificationsIcon }].map(
              (item) => (
