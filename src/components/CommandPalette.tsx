        ...
        <Command.List className="command-list">
          ...
          <Command.Group heading="Navigation" className="command-group">
            ...
            <Command.Item
              ...
              className="command-item"
            >
              <ExploreIcon fontSize="small" sx={{ mr: 1.5 }} />
              Browse Templates
            </Command.Item>
          </Command.Group>
          ...
          <Command.Group heading="Actions" className="command-group">
            {onCreateCanvas && (
              <Command.Item onSelect={() => handleSelect(onCreateCanvas)} className="command-item">
            ...
            {onSearch && (
              <Command.Item onSelect={() => handleSelect(onSearch)} className="command-item">
            ...
            {onExport && (
              <Command.Item onSelect={() => handleSelect(onExport)} className="command-item">
          ...
          <Command.Group heading="View" className="command-group">
            {onToggleGrid && (
              <Command.Item onSelect={() => handleSelect(onToggleGrid)} className="command-item">
            ...
            {onToggleTheme && (
              <Command.Item onSelect={() => handleSelect(onToggleTheme)} className="command-item">
                {isDarkMode ? (
