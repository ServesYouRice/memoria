...
Fill `Choice`; an executor then moves the related card to `READY`.

| ID | Decision | Recommended | Choice | Unblocks |
|---|---|---|---|---|
| DEC-001 | Self-host registration default | `closed` (`open` in dev) | _unset_ | [IMP-003](tasks/IMP-003.md) |
| DEC-002 | Agent external webhooks in v1 | Gate off until outbox ships | _unset_ | IMP-015 |
| DEC-003 | Templates: repair or hide | Hide until safe cloning ships | _unset_ | [IMP-010](tasks/IMP-010.md) |
| DEC-004 | Undo/redo: repair or hide | Hide until identity-safe restore ships | _unset_ | [IMP-011](tasks/IMP-011.md) |
| DEC-005 | Polls: repair or hide | Hide until server-authoritative voting ships | _unset_ | [IMP-012](tasks/IMP-012.md) |
| DEC-006 | Rich text: versioned JSON or plain text | Versioned Tiptap JSON | _unset_ | [IMP-013](tasks/IMP-013.md) |
...
| DEC-009 | Accessibility launch bar | Accessible DOM item list before public launch | _unset_ | [IMP-022](tasks/IMP-022.md) |
| DEC-010 | Recovery target and drill environment | Name S3/Postgres target, owner, RPO/RTO | _unset_ | IMP-021 |
| DEC-011 | Embeds | Link previews, not live embeds | _unset_ | [IMP-032](tasks/IMP-032.md) |
